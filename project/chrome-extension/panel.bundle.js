(() => {
  ...
  // src/ExtensionPanel.jsx
  var API_BASE = "https://feisty-renewal-production.up.railway.app";
  function ExtensionPanel() {
    ...
    async function findDeals() {
      ...
      setLoading(true);
      try {
        const res = await axios_default.post(`${API_BASE}/api/commerce/deals`, {
          asin
        });
        setData(res.data);
      } catch (err) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { padding: 20 } }, /* @__PURE__ */ React.createElement("h2", { style: { marginTop: 0 } }, "FBAlgo Deal Finder"), /* @__PURE__ */ React.createElement("p", { style: { opacity: 0.7 } }, "ASIN: ", asin), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: findDeals,
        style: {
      ...
      "Find Deals"
    ), loading && /* @__PURE__ */ React.createElement("p", null, "Loading..."), data && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 18 } }, data.error && /* @__PURE__ */ React.createElement("p", { style: { color: "red" } }, "Error: ", data.error), data.amazon_price && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", null, "Amazon Price: $", data.amazon_price), /* @__PURE__ */ React.createElement("p", null, "Walmart Price: $", data.walmart_price), /* @__PURE__ */ React.createElement(
      "a",
      {
  ...
  function initPanel() {
    ...
    root.render(/* @__PURE__ */ import_react2.default.createElement(ExtensionPanel, null));
  }
})();
